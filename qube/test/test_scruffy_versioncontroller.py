...
HELLO_VERSION = "/v1/scruffy/version"
...
class TestScruffyVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_scruffy_default_version(self, *args, **kwargs):
    ...
    def test_scruffy_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
