...
from qube.src.api.scruffycontroller import ScruffyController
from qube.src.api.scruffycontroller import ScruffyItemController
from qube.src.api.versioncontroller import ScruffyItemVersionController
...
api.add_resource(ScruffyItemVersionController, '/v1/scruffy/version')
api.add_resource(ScruffyController, '/v1/scruffy')
api.add_resource(ScruffyItemController, '/v1/scruffy/<string:entity_id>')
